...
const youtube = new YouTube("AIzaSyBkNdAEoXeZ1leKWmUKGo0G8arp5nQdVCg"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBkNdAEoXeZ1leKWmUKGo0G8arp5nQdVCg"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@667449992746631179>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name === "📜┇𝐿𝑂𝐺"); //// تعديل اساسي
      if (!channel) return;
